...
/* ═══════════════════════════════════════════════════════
   Intents Page — CRUD for chatbot intents
   Table + Create/Edit modal
   ═══════════════════════════════════════════════════════ */

// Mock data — nanti diganti dengan SWR fetch
interface Intent {
    id: string;
    tag: string;
    patterns: string[];
...
const mockIntents: Intent[] = [
    {
        id: '1',
        tag: 'greeting',
        patterns: ['halo', 'hi', 'hey', 'selamat pagi', 'assalamualaikum'],
        responses: ['Halo! Ada yang bisa dibantu?', 'Hi! Selamat datang di ReonShop 😊'],
        patternsCount: 5,
        responsesCount: 2,
    },
    {
        id: '2',
        tag: 'tanya_harga',
        patterns: ['berapa harganya', 'harga hp', 'price list', 'daftar harga'],
        responses: ['Silakan cek katalog kami di website ya!', 'Harga tergantung tipe dan spesifikasi.'],
        patternsCount: 4,
        responsesCount: 2,
    },
    {
        id: '3',
        tag: 'tanya_stok',
        patterns: ['stok masih ada', 'ready stock', 'tersedia gak', 'ada barangnya'],
        responses: ['Untuk cek stok, bisa sebutkan tipe yang dimaksud?'],
        patternsCount: 4,
        responsesCount: 1,
    },
    {
        id: '4',
        tag: 'tanya_promo',
        patterns: ['ada promo', 'diskon', 'potongan harga', 'cashback'],
        responses: ['Promo terbaru kami! Diskon 10% untuk pembelian pertama 🎉'],
        patternsCount: 4,
        responsesCount: 1,
    },
    {
        id: '5',
        tag: 'goodbye',
        patterns: ['bye', 'dadah', 'sampai jumpa', 'makasih'],
        responses: ['Terima kasih sudah menghubungi kami!', 'Sampai jumpa! 👋'],
        patternsCount: 4,
        responsesCount: 2,
    },
    {
        id: '6',
        tag: 'tanya_ongkir',
        patterns: ['ongkos kirim', 'berapa ongkirnya', 'biaya pengiriman'],
        responses: ['Ongkir tergantung lokasi. Bisa pakai JNE, J&T, atau SiCepat.'],
        patternsCount: 3,
        responsesCount: 1,
    },
];
                        ...
                        >
                            ...
                            <div className="flex justify-center gap-1">
                                ...
                                <button
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        setShowDeleteConfirm(intent.id);
                                    }}
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        {selectedIntent.patterns.map((pattern, i) => (
                                            <div
                                                key={i}
                                                className="flex items-center gap-3 px-4 py-2.5 bg-background rounded-xl text-sm text-foreground"
                                            >
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        {selectedIntent.responses.map((response, i) => (
                                            <div
                                                key={i}
                                                className="px-4 py-3 bg-success-light/30 border border-success/20 rounded-xl text-sm text-foreground"
                                            >
                                                {response}
                                            </div>
                                        ))}
                    ...
                    <>
                        ...
                        >
                            ...
                            <p className="text-sm text-text-secondary text-center mb-6">
                                Intent &ldquo;{intents.find((i) => i.id === showDeleteConfirm)?.tag}&rdquo; beserta semua patterns dan responses akan dihapus permanen.
                            </p>
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="flex-1 py-2.5 px-4 bg-danger text-white rounded-xl text-sm font-medium hover:bg-red-600 transition-colors"
                                >
                                    Ya, Hapus
                                </button>
                            </div>
